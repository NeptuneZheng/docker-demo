...
public class compareCOSUBORunSI {
    private static Logger logger = LogManager.getLogger(compareCOSUBORunSI.class.getName());
    ...
    public static void main(String[] args) {
        String testPath = "D:\\1_B2BEDI_Revamp\\SI\\OUT_UIF\\COSU_UIF";
    ...
    public static void compare(File expected,File actual,File excel,String testPath,String gitIS_Path){
      ...
      //  ignoredSegmentList.add("<CUSTOMER_300>;</CUSTOMER_300>");
        ...
        ignoredList.add("<MSGDATE>");
        ignoredList.add("<MSGTIME>");
        ignoredList.add("<MSGBATCHNO>");
        ignoredList.add("T999RECORDCOUNT");
